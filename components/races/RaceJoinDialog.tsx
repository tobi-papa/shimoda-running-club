...
interface RaceJoinDialogProps {
  event: RaceEvent | null;
  onClose: () => void;
  onJoin: (eventId: string, names: string[]) => void;
}

export function RaceJoinDialog({ event, onClose, onJoin }: RaceJoinDialogProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="display" style={{ fontSize: 22 }}>JOIN RACE</div>
        ...
        <div style={{ padding: 24 }}>
          <div style={{ marginBottom: 18 }}>
            <div className="mono" style={{ fontSize: 11, letterSpacing: "0.1em", color: "var(--muted)" }}>
              {d.day} {d.dd} {d.mon} · {event.distance_km}KM · {event.location}
            </div>
