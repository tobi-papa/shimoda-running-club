...
import type { RaceEvent, RaceType } from "@/types";
...
interface EditRaceEventModalProps {
...
export function EditRaceEventModal({ event, onClose, onSave }: EditRaceEventModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="display" style={{ fontSize: 22 }}>EDIT RACE EVENT</div>
